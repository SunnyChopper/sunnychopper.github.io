        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-blue-800 dark:text-blue-400 text-sm">
              In the next update, your Skill Tree will automatically populate based on completed
              courses and lessons, showing prerequisites, recommended learning paths, and skill
              connections.
            </p>
          </div>
        </div>
