  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 mb-8 border border-gray-200 dark:border-gray-700">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">How Layers Integrate</h2>
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Goals Drive Projects</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center text-green-600 dark:text-green-400 font-bold">
              2
            </div>
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Projects Create Tasks</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center text-orange-600 dark:text-orange-400 font-bold">
              3
            </div>
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Metrics Measure Progress</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-purple-600 dark:text-purple-400 font-bold">
              4
            </div>
            <div className="flex-1">
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Reflection Informs Strategy</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-900/50">
            <p className="text-sm text-gray-700 dark:text-gray-300 italic">
              <strong>The Result:</strong> A continuous cycle where strategic vision guides daily actions, metrics validate progress, and reflection drives continuous improvement. Each layer reinforces the others, creating a compound effect on your growth.
            </p>
          </div>
        </div>
      </div>
