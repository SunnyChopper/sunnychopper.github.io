...
import { ArrowLeft, BookOpen, Clock, CircleCheck as CheckCircle2, Circle, ChevronRight, Sparkles, Play, Copy, Check, PanelLeftClose, PanelLeftOpen, SkipBack, SkipForward } from 'lucide-react';
...
export default function CourseDetailPage() {
  ...
  const [generationProgress, setGenerationProgress] = useState<LessonGenerationProgress | null>(null);
  ...
  const handleCopyToMarkdown = async () => {
    ...
    try {
      ...
      const markdown = `# ${selectedLesson.title}\n\n${
        selectedLesson.estimatedMinutes ? `**Duration:** ${selectedLesson.estimatedMinutes} minutes\n\n` : ''
