...
import { getWeeklyData, getMonthlyData, calculateTrend, getLogsForDateRange } from '../../utils/habit-analytics';
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Performance Comparison</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-5 border border-gray-200 dark:border-gray-600">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-base font-semibold text-gray-900 dark:text-white">Current {viewMode === 'week' ? 'Week' : 'Month'}</h4>
            ...
            <div>
              ...
              <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: `${Math.min(100, (current.completions / Math.max(current.expected, 1)) * 100)}%` }}
                />
              </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-5 border border-gray-200 dark:border-gray-600">
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-base font-semibold text-gray-900 dark:text-white">Previous {viewMode === 'week' ? 'Week' : 'Month'}</h4>
            ...
            <div>
              ...
              <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: `${Math.min(100, (previous.completions / Math.max(previous.expected, 1)) * 100)}%` }}
                />
              </div>
              <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-center">
          <div className="text-center bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              {Math.abs(trend.changePercent).toFixed(0)}% {trend.isImproving ? 'increase' : 'decrease'}
            </div>
          </div>
        </div>
      </div>
