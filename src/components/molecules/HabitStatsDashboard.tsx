    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <HabitStatCard
          ...
          progress={habit.dailyTarget ? undefined : {
        ...
        <HabitStatCard
          ...
          trend={stats.trend.changePercent !== 0 ? {
      ...
      {stats.streaks.allStreaks.length > 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              Longest: <span className="font-semibold text-gray-900 dark:text-white">{stats.streaks.longest} days</span>
            </div>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min(100, stats.streaks.longest > 0 ? (streak.length / stats.streaks.longest) * 100 : 0)}%` }}
                      />
                    </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Streak History</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">No streaks recorded yet. Start logging completions to build your first streak!</p>
        </div>
      )}
    </div>
  );
