        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 z-50 pointer-events-none">
            <motion.div
              ...
              className={cn(
                'bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6 pointer-events-auto relative',
                className
              )}
            >
              <button
              ...
              {title && (
                <h3 className="text-2xl font-bold mb-4 pr-8 text-gray-900 dark:text-white">{title}</h3>
              )}
